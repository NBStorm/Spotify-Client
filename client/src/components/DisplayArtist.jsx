...
const DisplayAlbum = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center space-x-4 bg-[#121212] p-4">
        {/* Play Button */}
        <button className="w-10 h-10 flex items-center justify-center bg-green-500 rounded-full hover:scale-105 transition-transform duration-200">
          <svg
            className="w-3.5 h-3.5 text-black ml-0.5"
            fill="currentColor"
            viewBox="0 0 16 16"
          >
            <path d="M4 3.3v9.4c0 .5.5.8.9.5l7.4-4.7c.4-.3.4-.8 0-1.1L4.9 2.7c-.4-.3-.9 0-.9.6z" />
          </svg>
        </button>
      ...
      <section className="text-white p-6">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-black/10 p-6">
            <p className="font-bold text-base mb-3">1,695,449 monthly listeners</p>
            ...
            <div className="flex flex-col md:flex-row bg-black px-6 py-6 gap-6">
              ...
              <div className="flex-shrink-0 text-left space-y-4 min-w-[160px]">
                ...
                <div className="text-white space-y-4 mt-8">
                  <a href="https://facebook.com" className="flex items-center space-x-2 hover:underline">
                    <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d="M22 12a10 10 0 1 0-11.6 9.87v-6.99H8v-2.88h2.4V9.41c0-2.37 1.42-3.68 3.6-3.68 1.04 0 2.13.19 2.13.19v2.34h-1.2c-1.18 0-1.54.74-1.54 1.49v1.78H17l-.4 2.88h-2.4v6.99A10 10 0 0 0 22 12z" /></svg>
                    <span>Facebook</span>
                  </a>

                  <a href="https://instagram.com" className="flex items-center space-x-2 hover:underline">
                    <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm10 2c1.66 0 3 1.34 3 3v10c0 1.66-1.34 3-3 3H7c-1.66 0-3-1.34-3-3V7c0-1.66 1.34-3 3-3h10zm-5 3a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 2a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm4.5-.9a1.1 1.1 0 1 1-2.2 0 1.1 1.1 0 0 1 2.2 0z" /></svg>
                    <span>Instagram</span>
                  </a>

                  <a href="https://twitter.com" className="flex items-center space-x-2 hover:underline">
                    <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24"><path d="M22.46 6c-.77.35-1.6.58-2.46.69a4.3 4.3 0 0 0 1.89-2.38 8.56 8.56 0 0 1-2.71 1.03A4.28 4.28 0 0 0 11.07 8c0 .34.04.68.1 1A12.14 12.14 0 0 1 3 5.16a4.28 4.28 0 0 0 1.32 5.71A4.21 4.21 0 0 1 2.8 10v.05a4.28 4.28 0 0 0 3.43 4.2 4.27 4.27 0 0 1-1.12.15c-.28 0-.56-.03-.83-.08a4.29 4.29 0 0 0 4 2.97A8.58 8.58 0 0 1 2 19.54a12.07 12.07 0 0 0 6.56 1.92c7.88 0 12.2-6.53 12.2-12.2 0-.18 0-.36-.01-.53A8.67 8.67 0 0 0 24 5.3a8.48 8.48 0 0 1-2.54.7z" /></svg>
                    <span>x</span>
                  </a>

                  <a href="https://wikipedia.org" className="flex items-center space-x-2 hover:underline">
                    <svg className="w-5 h-5 stroke-white" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" strokeWidth="2" d="M14 3h7v7m0-7L10 14m-4 1h4v4H5v-9h4z" /></svg>
                    <span>Wikipedia</span>
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2 text-white text-sm mt-6 ">
                  ...
                  />
                  <span>
                    Posted By <span className="font-medium">{artistData.name}</span>
                  </span>
                </div>
              </div>
            </div>
